...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lazyloadImage = __webpack_require__(1);
	...
	(0, _lazyloadImage2.default)(opt);

	function $(selector) {
	    if (typeof selector === 'string') {
	        return _container.Container.of(document.querySelectorAll(selector));
	    }
	    return _container.Container.of([selector]);
	}
	//组合方法
	function compose() {
	...
	function firstOfArray(arr) {
	    try {
	        return _container.Container.of(arr.__value[0]);
	    } catch (e) {
	        return _container.Left.of(e);
	    }
	}
	...
	//添加图片方法
	var addItem = compose(append(createEl), firstOfArray, $);
...
/***/ function(module, exports) {
	...
	Container.prototype.map = function (fn, restrictObject) {
	    if (isArray(this.__value) && !restrictObject) {
	        ...
	        var _value = fn(this.__value);
	        return _value instanceof Left ? _value : Container.of(_value);
	    }
	};
	//filter
